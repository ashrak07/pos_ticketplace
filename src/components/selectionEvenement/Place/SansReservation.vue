...
export default {
  setup() {
    ...
    const A = computed(() => ticketStore.getA);
    ...
    const ajouter = (ticket, index) => {
      ...
      const data = cartStore.getCartItems;
      console.log("voici ticketData depuis le store:", data);
